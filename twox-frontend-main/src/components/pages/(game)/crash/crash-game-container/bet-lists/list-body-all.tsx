  ...
  return (
    ...
    >
      ...
      <div className={cn('bet-list-body-content')}>
        ...
        <div className='body custom-scrollbar h-[460px] max-h-[460px] overflow-y-auto'>
          {players &&
            players.map((player: any, index: number) => (
              ...
              >
                ...
                <div className='multiplier col-span-3'>
                ...
                <div className='amount col-span-3 flex items-center gap-1'>
                  <CoinIcon />
                  {player.winningAmount && Number(player.winningAmount) > 0 ? (
...
export default memo(ListBodyAll)
