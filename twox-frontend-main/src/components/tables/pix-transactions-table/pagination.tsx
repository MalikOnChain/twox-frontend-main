  ...
  return (
    <div className={`mt-2 flex items-center ${className}`}>
      <button
        ...
        className='shadow-theme-xs mr-2.5 flex h-10 items-center justify-center rounded-lg border border-gray-700 bg-gray-800 px-3.5 py-2.5 text-sm text-gray-400 hover:bg-gray-50 hover:bg-white/[0.03] disabled:opacity-50'
      >
      ...
      <button
        ...
        className='shadow-theme-xs ml-2.5 flex h-10 items-center justify-center rounded-lg border border-gray-700 bg-gray-800 px-3.5 py-2.5 text-sm text-gray-400 hover:bg-gray-50 hover:bg-white/[0.03] disabled:opacity-50'
      >
        <span className='block md:hidden'>{'>'}</span>
