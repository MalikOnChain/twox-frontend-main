...
export function formatNumber(value: number | string): string {
  try {
    ...
    throw new Error('Invalid number detected in utils.ts')
  }
}

export function getRemainingDays(date: string | null): string | number | null {
  if (!date) return null
...
export function getTierClassName(tier: VIP_TIERS): string {
  switch (tier) {
